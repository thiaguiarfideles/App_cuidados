...
class Farm_medicamentos(models.Model):
...
class Nome_paciente(models.Model):
    paciente = models.CharField(max_length=200, blank=True, null=True)
...
class Medico(models.Model):
    ...
    especialidade = models.ForeignKey(Especialidade, on_delete = models.SET_NULL, blank = True, null = True, verbose_name="Especialidade")
    id_medico = models.AutoField(primary_key=True)
    email = models.EmailField(verbose_name="Email", max_length=200, blank=True, null=True)
    crm = models.DecimalField(verbose_name="Cod Conselho", max_digits=12, decimal_places=2, blank=True, null=True)
...
class DadosPaciente(models.Model):
    nome = models.ForeignKey(Nome_paciente, on_delete = models.SET_NULL, blank = True, null = True, verbose_name="Paciente")
    comentarios = models.TextField(blank=True, null=True,verbose_name="Comentarios")
    medico = models.ForeignKey(Medico, on_delete = models.SET_NULL, blank = True, null = True, verbose_name="Nome Medico")
    email = models.EmailField(verbose_name="Email", max_length=200, blank=True, null=True)
    cidade = models.CharField(verbose_name="Cidade", max_length=200, blank=True, null=True)
    ...
    nm_medicamento = models.ForeignKey(Farm_medicamentos, on_delete = models.SET_NULL, blank = True, null = True)
...
class Medicamentos(models.Model):
    ...
    medicamento_import = models.FileField(verbose_name="Import Receita", blank=True, null=True, upload_to='media/')
    paciente = models.ForeignKey(DadosPaciente, on_delete = models.SET_NULL, blank = True, null = True)
    user = models.ForeignKey(User, on_delete=models.CASCADE, blank=True)
    date_add = models.DateTimeField(default = timezone.now)
    quantidade = models.IntegerField()
    vencimento = models.DateField(auto_now=False,auto_now_add=False, default = timezone.now)
    fabricacao = models.DateField(auto_now=False,auto_now_add=False, default = timezone.now)



    def __str__(self):
        return self.nm_medicamento
