...
class PrestadorPessoaFisicaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                css_class="row",),
            Div(
                Div(Field('medico_responsavel'), css_class="col-md-5", ),
            ...
            Div(
                ...
                Div(Field('convenio'), css_class="col-md-3", ),
                Div(Field('doenca_base'), css_class="col-md-3", ),
                css_class="row",), 
            Div(
                Div(Field('medicamento'), css_class="col-md-4", ),
                Div(Field('horarios_medicacao'), css_class="col-md-3", ),
                Div(Field('peso'), css_class="col-md-2", ),
                Div(Field('altura'), css_class="col-md-2", ),
                Div(Field('temperatura'), css_class="col-md-2", ),
                Div(Field('glicemia'), css_class="col-md-3", ),
                Div(Field('frequencia_cardiaca'), css_class="col-md-3", ),
                css_class="row",), 
            Div(
                Div(Field('alergia',), css_class="col-md-2", ),
                Div(Field('tipo_alergia'), css_class="col-md-2", ),
                Div(Field('nivel_alergia'), css_class="col-md-2", ),
                css_class="row",), 
    ...
    class Meta:
        ...
        #           'observacoes']
        fields = ['sn_cuidador','sn_paciente', 'nm_prestador', 'nr_cpf_cgc', 'dt_nascimento', 
                  'ds_codigo_conselho', 'especialidades','medico_responsavel','hospital_referencia',
                  'convenio','doenca_base','medicamento','horarios_medicacao','peso','altura','temperatura','glicemia',
                  'frequencia_cardiaca','alergia','tipo_alergia','nivel_alergia',
