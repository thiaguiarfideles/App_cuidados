...
class PrestadorPessoaFisicaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['sn_cirurgiao'].label = "É Cirurgião?"
        # self.fields["especialidades"].widget = forms.widgets.CheckboxSelectMultiple()
        self.helper.layout = Layout(
            Div(
                Div(Field('sn_cirurgiao',), css_class="col-md-3", ),
            ...
            Div(
                ...
                Div(Field('ds_codigo_conselho'), css_class="col-md-3", ),
            ...
            Div(
                ...
                css_class="row", ),
            Div(
                         Div(Field('banco'), css_class="col-md-3", ),
                         Div(Field('ds_agencia'), css_class="col-md-3", ),
                         Div(Field('nr_conta'), css_class="col-md-3", ),
                css_class="row", ),
            Div(
